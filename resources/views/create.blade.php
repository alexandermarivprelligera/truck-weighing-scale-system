...
<input type="hidden" name="transaction_no" value="{{ $transactionNo }}">
    ...
    <div class="grid grid-cols-3 gap-4">
        ...
        <div>
            <input type="number" id="gross_weight" name="gross_weight" readonly class="p-2 border rounded w-full bg-white-100" placeholder="Gross Weight">

            <button type="button" onclick="captureWeight('gross')" class="mt-2 bg-blue-600 text-white px-3 py-2 rounded 
        ...
        <div>
            ...
            <!--button type="button" onclick="captureWeight('tare')"class="mt-2 bg-green-600 text-white px-3 py-2 rounded 
